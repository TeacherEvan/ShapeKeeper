...
document.body.style.background = 
    `radial-gradient(ellipse at ${cursorX}% ${cursorY}%, 
     hsl(${hue1}, 40%, 15%), 
     hsl(${hue1 + 30}, 30%, 8%))`;
```
...
const isDiagonal = Math.abs(dot1.row - dot2.row) === 1 && 
                   Math.abs(dot1.col - dot2.col) === 1;
...
*This plan is designed to be flexible. Pick any phase, any feature. Each stands alone but all compose together into something greater.*
